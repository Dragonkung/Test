...
_G.Settings = {
    ...
    ["No Explosions"] = false, -- Makes Explosion's invisible
    ["No Clothes"] = false, -- Removes Clothing from the game
    ["Low Water Graphics"] = true, -- Removes Water Quality
    ["No Shadows"] = true, -- Remove Shadows
    ["Low Rendering"] = false, -- Lower Rendering
...
--เปิดหาพ่อง
    ...
    local k = SOMEXHUB:AddTab("อื่นๆสำหรับเผ่า 4","6034900727")
...
Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719)
        ...
        loadstring(game:HttpGet(('https://pastebin.com/raw/5qKtbuWY')))()
    end)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,300,0)
 ...
 Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625)
    ...
    n:AddButton("เกาะ ต้นไม้",function()
...
n:AddButton("เกาะฟาร์มกระดูก",function()
game.Players.LocalPlayer.Character.Head:Destroy()
...
--Dun
k:AddSeperator("ชิบลงดัน")
k:AddButton("ดันไฟ",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flame-Flame") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flame-Flame")
end)
k:AddButton("ดันน้ำเเข็ง",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Ice-Ice") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ice-Ice")
end)
k:AddButton("ดันสั่น",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Quake-Quake") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Quake-Quake")
end)
k:AddButton("ดันเเสง",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Light-Light") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Light-Light")
end)
k:AddButton("ดันมืด",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("String-String") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dark-Dark")
end)
k:AddButton("ดันด้าย",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("String-String") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("String-String")
end)
k:AddButton("ดันสายฟ้า",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Rumble-Rumble") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rumble-Rumble")
end)
k:AddButton("ดันเเมกม่า ",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Magma-Magma") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Magma-Magma") 
end)
k:AddButton("ดันพระ ",function()
...
k:AddButton("ดันทราย",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sand-Sand") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sand-Sand")
end)
k:AddButton("ดัน ฟินิกซ์",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Bird-Bird: Phoenix") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird-Bird: Phoenix")
end)
k:AddButton("ดันโมจิ",function()
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dough") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dough")
end)
k:AddSeperator("ลงดัน")
k:AddButton("เริ่มลงดัน!!",function()
fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
end)

k:AddToggle("Kill Aura ",_G.KillAura,function(value)
        _G.KillAura = value
    end)
...
rn:AddSeperator("Server")
 rn:AddButton("Rejoin",function()
 game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").localPlayer)
    end)
    rn:AddButton("FPS Boost",function()
    loadstring(game:HttpGet("https://pastebin.com/raw/RVTWYUUB"))()
    end)
    
    k:AddToggle("เดินบนน้ำ ",_G.WalkWater,function(value)
        _G.WalkWater = value
    end)
...
u:AddSeperator("Update 4 (Big)")
u:AddLabel("-Add New Island Bypass TP")
u:AddLabel("-Upgrade Anti Lag!!")
u:AddLabel("-Upate Stability")
u:AddLabel("[Fix All Bugs]")
u:AddLabel("Bug Ui Cant Show")
u:AddLabel("Function Fake?")
u:AddLabel("Ui On/Off")
u:AddLabel("Kill Aura Slow")
u:AddLabel("-Add Anti AFK")
u:AddLabel("-Add Button Rejoin")
u:AddLabel("-Add Button FPS Boost!!")
u:AddSeperator("Update 4.1 (Mini)")
u:AddLabel("-Add ไปดูเอาเอง จบ")
